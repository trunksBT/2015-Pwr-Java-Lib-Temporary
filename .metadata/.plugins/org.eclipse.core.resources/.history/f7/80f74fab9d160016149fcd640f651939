...
import bt.core.algorithms.sorting.BucketSort;
import bt.core.collections.dataTypes.ArrayList;
import bt.core.collections.interfaces.List;
import junit.framework.TestCase;

@FixMethodOrder(MethodSorters.NAME_ASCENDING)
public class TestBucketSort extends TestCase
{
	//Test_MethodName_StateUnderTest_Expect_ExpectedBehavior
	@Test
	public void test_BucketSort_63124805_Expect_01234568_True()
	{
	    //arrange	    
	    ...
	    //act
		orderedTape = new BucketSort().sort(tape);
	...
	//Test_MethodName_StateUnderTest_Expect_ExpectedBehavior
	@Test
	public void test_BucketSort_63124805_10_7_9_15_11_13_12_14_Expect_0123456789101112131415_True()
	{
	    //arrange	    
		List tape = new ArrayList(10);
		List orderedTape = null;
		...
		//Test_MethodName_StateUnderTest_Expect_ExpectedBehavior
		@Test
		public void test_BucketSort_empty_Expect_empty_True()
		{
		    //arrange	    
			List tape = new ArrayList(10);
			List orderedTape = null;
		...
		//Test_MethodName_StateUnderTest_Expect_ExpectedBehavior
		@Test
		public void test_BucketSort_012345678_Expect_012345678_True()
		{
		    //arrange	    
			List tape = new ArrayList(10);
			List orderedTape = null;
		...
		//Test_MethodName_StateUnderTest_Expect_ExpectedBehavior
		@Test
		public void test_BucketSort_876543210_Expect_012345678_True()
		{
		    //arrange	    
			List tape = new ArrayList(10);
			List orderedTape = null;
