...
public class TestGuardedLinkedListDoubleCopy extends TestCase {
    ...
    @Test
    public void test_get_notEmpty_2nd_true()
    {
    	// arrange
    	List tape = new GuardedLinkedListDoubleCopy();
    	Object rcVal = null;
    	String expVal =  new String("2");
    	String yetAdded0 = new String("0");
    ...
    public void test_set_notEmpty_true()
    {
    	...
    	Object expVal = new String("1");
    	int desIdx = 0;
    	
    	// act
    	tape.add(yetAdded1);
    	tape.set(desIdx,toAdd1);
    	rcVal = tape.get(desIdx);
