...
import bt.core.algorithms.sorting.HeapSort;
...
public class TestHeapSort extends TestCase
{
	...
	@Test
	public void test_HeapSort_63124805_Expect_01234568_True()
	{
	    //arrange	    
	    ...
	    //act
		orderedTape = new HeapSort(NaturalComparator.INSTANCE).sort(tape);
	...
	//Test_MethodName_StateUnderTest_Expect_ExpectedBehavior
	@Test
	public void test_HeapSort_63124805_10_7_9_15_11_13_12_14_Expect_0123456789101112131415_True()
	{
	    //arrange	    
		List tape = new ArrayList(10);
		List orderedTape = null;
		...
		//Test_MethodName_StateUnderTest_Expect_ExpectedBehavior
		@Test
		public void test_HeapSort_empty_Expect_empty()
		{
		    //arrange	    
			List tape = new ArrayList(10);
			List orderedTape = null;
			...
			orderedTape = new HeapSort(NaturalComparator.INSTANCE).sort(tape);
		    //assert
		    assertTrue(orderedTape.isEmpty());
		}
		
		//Test_MethodName_StateUnderTest_Expect_ExpectedBehavior
		@Test
		public void test_HeapSort_012345678_Expect_012345678_True()
		{
		    //arrange	    
			List tape = new ArrayList(10);
			List orderedTape = null;
		...
		//Test_MethodName_StateUnderTest_Expect_ExpectedBehavior
		@Test
		public void test_HeapSort_876543210_Expect_012345678_True()
		{
		    //arrange	    
			List tape = new ArrayList(10);
			List orderedTape = null;
