package bt.tests.core.collections.lists;
...
import bt.core.collections.lists.AbstractList;
...
public class Test_DirtyListDecorator extends TestCase {
    ...
    {
    	// arrange
    	List tape = new DirtyListDecorator(new LinkedList());
    	int expSize = 0;
	...
	//Test_MethodName_StateUnderTest_Expect_ExpectedBehavior
    @Test
    public void test_contains_isDirty_empty_false()
    {
    	// arrange
    	List tape = new DirtyListDecorator(new LinkedList());
    	String searchedVal = new String("0");
    	...
    	// assert
    	assertFalse(rcVal);
    	assertFalse(((DirtyListDecorator)tape).isDirty());
    }
    
	//Test_MethodName_StateUnderTest_Expect_ExpectedBehavior
    @Test
    public void test_contains_isDirty_notEmpty_false_1()
    {
    	// arrange
    	List tape = new DirtyListDecorator(new LinkedList());
    	String searchedVal = new String("0");
	...
	//Test_MethodName_StateUnderTest_Expect_ExpectedBehavior
    @Test
    public void test_contains_isDirty_notEmpty_false_2()
    {
    	// arrange
    	List tape = new DirtyListDecorator(new LinkedList());
    	String searchedVal = new String("0");
    ...
    @Test
    public void test_isDirty_notEmpty_true_1()
    {
    	// arrange
    	List tape = new DirtyListDecorator(new LinkedList());
    	Object rcVal = null;
    	...
    	assertTrue(((DirtyListDecorator)tape).isDirty());
    }
    
    @Test
    public void test_isDirty_notEmpty_true_2()
    {
    	// arrange
    	List tape = new DirtyListDecorator(new LinkedList());
    	Object rcVal = null;
	...
	//Test_MethodName_StateUnderTest_Expect_ExpectedBehavior
    @Test
    public void test_isDirty_empty_true()
    {
    	// arrange
    	List tape = new DirtyListDecorator(new LinkedList());
    	Object rcVal = null;
    ...
    @Test
    public void test_setDirty_notEmpty_true()
    {
    	// arrange
    	List tape = new DirtyListDecorator(new LinkedList());
    	tape.add("3");
    	// act
    	((DirtyListDecorator)tape).setDirty(true);
	...
	//Test_MethodName_StateUnderTest_Expect_ExpectedBehavior
    @Test
    public void test_setDirty_empty_true()
    {
    	// arrange
    	List tape = new DirtyListDecorator(new LinkedList());
...
//    //Test_MethodName_StateUnderTest_Expect_ExpectedBehavior
//    @Test
//    public void test_isDirty_false() {
//    	List tape = new DirtyListDecorator(new LinkedList());
//    	
//    }
}
