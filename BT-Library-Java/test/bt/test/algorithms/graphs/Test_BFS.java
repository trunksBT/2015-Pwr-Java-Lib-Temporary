...
//	}
	...
	@Test
	public void test_adjacentList_013245678()
	{
	    //arrange
		ArrayList rcVal = null;
		int inSize = 9;
	...
	public void test_adjacentList_Null_Empty()
	{
		...
		ArrayList rcVal = null;
		int inSize = 9;
		Graph<Integer,String> graph = new AdjacentList<String>(mockAdjacentListNull(inSize));
	    boolean rcLogic = true;
	...
	@Test
	public void test_adjacentList_TwoElem_01()
	{
	    //arrange
		ArrayList rcVal = null;
		int inSize = 2;
