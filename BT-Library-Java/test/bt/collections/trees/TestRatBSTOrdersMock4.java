...
public class TestRatBSTOrdersMock4 extends TestCase {
    ...
    public RatNode getMock4() {
    	return		new RatNode(4,new RatNode(2,new RatNode(1),new RatNode(3)),new RatNode(6,new RatNode(5),new RatNode(7)));
    }
}
