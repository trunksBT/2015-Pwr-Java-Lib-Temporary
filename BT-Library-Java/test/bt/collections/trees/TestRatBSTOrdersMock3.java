...
public class TestRatBSTOrdersMock3 extends TestCase {
    ...
    public RatNode getMock3() {
    	return		new RatNode(2,new RatNode(1,new RatNode(0),null),new RatNode(4,new RatNode(3),new RatNode(5)));
    }
}
