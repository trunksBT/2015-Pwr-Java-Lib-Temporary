...
//    {
//        //act
//    	IGraf<String,Double> _network = new GraphIndirected<String,Double>(initList(),initMatrix());
//        assertTrue(true);
//    }
//    
//    @Test
...
//    {
//        //act
//    	IGraf<String,Double> _network = new GraphIndirected<String,Double>(null,initMatrix());
//        assertTrue(true);
//    }
//    
//    @Test
...
//    {
//        //act
//    	IGraf<String,Double> _network = new GraphIndirected<String,Double>(initList(),null);
//        assertTrue(true);
//    }
//    
//    @Test
...
//    	     
//        //act
//    	IGraf<String,Double> _network = new GraphIndirected<>(null,initMatrix());
...
//    	     
//        //act
//    	IGraf<String,Double> _network = new GraphIndirected<>(initList(),null);
//    	boolean reachedVal = _network.Wierzcholki().contains("Krakow");
//    	reachedVal &= _network.Wierzcholki().contains("Gdynia");
//    	reachedVal &= _network.Wierzcholki().contains("Ostrowiec");
//    	reachedVal &= _network.Wierzcholki().contains("Wroclaw");
...
//    	     
//        //act
//    	IGraf<String,Double> _network = new GraphIndirected<>(initList(),initMatrix());
