...
import bt.algorithms.sorting.SelectSort;
...
public class TestSelectSort extends TestCase
{
	...
	@Test
	public void test_SelectSort_63124805_Expect_01234568_True()
	{
	    //arrange	    
	    ...
	    //act
		orderedTape = new SelectSort(NaturalComparator.INSTANCE).sort(tape);
	...
	//Test_MethodName_StateUnderTest_Expect_ExpectedBehavior
	@Test
	public void test_SelectSort_63124805_10_7_9_15_11_13_12_14_Expect_0123456789101112131415_True()
	{
	    //arrange	    
		List tape = new ArrayList(10);
		List orderedTape = null;
		...
		//Test_MethodName_StateUnderTest_Expect_ExpectedBehavior
		@Test
		public void test_SelectSort_empty_Expect_empty_True()
		{
		    //arrange	    
			List tape = new ArrayList(10);
			List orderedTape = null;
		...
		//Test_MethodName_StateUnderTest_Expect_ExpectedBehavior
		@Test
		public void test_SelectSort_012345678_Expect_012345678_True()
		{
		    //arrange	    
			List tape = new ArrayList(10);
			List orderedTape = null;
		...
		//Test_MethodName_StateUnderTest_Expect_ExpectedBehavior
		@Test
		public void test_SelectSort_876543210_Expect_012345678_True()
		{
		    //arrange	    
			List tape = new ArrayList(10);
			List orderedTape = null;
